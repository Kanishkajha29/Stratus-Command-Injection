...
OS_SHELL = """stratus(""" + Style.BRIGHT + Fore.RED + """os_shell""" + Style.RESET_ALL + """) > """
REVERSE_TCP_SHELL = """stratus(""" + Style.BRIGHT + Fore.RED + """reverse_tcp""" + Style.RESET_ALL + """) > """
BIND_TCP_SHELL = """stratus(""" + Style.BRIGHT + Fore.RED + """bind_tcp""" + Style.RESET_ALL + """) > """
...
APPLICATION_URL = "https://stratusproject.com"
APPLICATION_X_ACCOUNT = "@stratusproject"
...
# Git URL.
GIT_URL = "https://github.com/stratusproject/" + APPLICATION + ".git"

# Git issue URL.
ISSUES_PAGE = "https://github.com/stratusproject/" + APPLICATION + "/issues/new"

stratus_ROOT_PATH = os.path.abspath(os.curdir)
...
# [1] https://github.com/stratusproject/stratus/wiki/Target-applications
